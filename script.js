...
var _rollbarConfig = {
  accessToken: "67a2201f14a3449697ee112fe46b198f",
...
function GenerateInfo() {
  ...
  _rollbarConfig.info(`Info message in rollbar now from clicking GenerateInfo button`);
...
function GenerateRandomErrors() {
  ...
  _rollbarConfig.critical(`${myString} error in rollbar now from clicking GenerateRandomErrors button`);
}
