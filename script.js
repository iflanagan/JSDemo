...
function GenerateInfo() {
  ...
  var rollbar = _rollbarConfig;

  console.log('Generating a information message');
  rollbar.info(`Info message in rollbar now from clicking GenerateInfo button`);
...
function GenerateRandomErrors() {
  ...
  rollbar.critical(`${myString} error in rollbar now from clicking GenerateRandomErrors button`);
}
