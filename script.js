...
let myEnv = getRandomEnv();
let version = stringGen(10);


var _rollbarConfig = {

  accessToken: "2274666826ae418c844b4f4b7d2ae879",
...
function getRandomEnv() {
  ...
  let myValue = randomIntFromInterval(0, 4);
  console.log(`My Environment is: ${myEnvironments[myValue]}`);
  return myEnvironments[myValue];
}
...
// used to randomize people tracking 
...
function GenerateInfo() {
  ...
  console.log('Generating a information message');

  for (let i = 1; i <= 5; i++) {

    Rollbar.log(`${i} Test Info Message sent by clicking GenerateInfo button`);
...
function GenerateDebug() {
  ...
  console.log('Generating a information message');
  Rollbar.debug("Test Info Message sent by clicking GenerateInfo button");
...
function GenerateCriticalErrors() {
  ...
  console.log('Generating a Critical error');
